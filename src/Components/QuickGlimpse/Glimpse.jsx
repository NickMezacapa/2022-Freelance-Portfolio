                ...
                <section className="container">
                    <div className="bio">
                        ...
                        <p className='bioContent'>
                            I'm a Full-Stack Engineer assisting startups in creating growth-driven products and brands.<span className='secondThought'> I believe the best software is created user-first, providing an <span className='bio-span'>experience</span> that keeps the users returning. I'm committed to building solutions to everyday problems and I put emphasis on the value that stems from a great application.</span>
                        </p>
                    </div>
